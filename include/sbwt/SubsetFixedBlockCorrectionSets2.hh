...
class SubsetFixedBlockCorrectionSetsRank2 {
 ...
 public:
  ...
  BlockedCorrectionSetsBase4RankFixed<4> the_data_structure;
  ...
  SubsetFixedBlockCorrectionSetsRank2() {}

  SubsetFixedBlockCorrectionSetsRank2(const sdsl::bit_vector& A_bits,
    ...
    the_data_structure = BlockedCorrectionSetsBase4RankFixed<4>(
  ...
  SubsetFixedBlockCorrectionSetsRank2(
      const SubsetFixedBlockCorrectionSetsRank2& other) {
    assert(&other != this);  // What on earth are you trying to do?
    operator=(other);
  }

  SubsetFixedBlockCorrectionSetsRank2& operator=(
      const SubsetFixedBlockCorrectionSetsRank2& other) {
    if (&other != this) {
